...
public class TileManager {
    ...
    public void getTileImage() {
        ...
        try {
            ...
            tile[11] = new Tile();
            tile[11].image = ImageIO.read(getClass().getResourceAsStream("/tiles1/tree.png"));
            ...
            tile[30] = new Tile();
            tile[30].image = ImageIO.read(getClass().getResourceAsStream("/officetiles/sleepingboss1.png"));
            tile[30].collision = true;

            tile[31] = new Tile();
            tile[31].image = ImageIO.read(getClass().getResourceAsStream("/tiles1/dooropen1.png"));

            /* illinois and indiana, some of KY */
            tile[32] = new Tile();
            tile[32].image = ImageIO.read(getClass().getResourceAsStream("/tiles1/yellowgrass.png"));

            tile[33] = new Tile();
            tile[33].image = ImageIO.read(getClass().getResourceAsStream("/tiles1/corn.png"));

            tile[34] = new Tile();
            tile[34].image = ImageIO.read(getClass().getResourceAsStream("/tiles1/yelgreen_grass.png"));

            tile[35] = new Tile();
            tile[35].image = ImageIO.read(getClass().getResourceAsStream("/tiles1/yelyelgreen_grass.png"));

            tile[36] = new Tile();
            tile[36].image = ImageIO.read(getClass().getResourceAsStream("/tiles1/black.png"));

            tile[37] = new Tile();
            tile[37].image = ImageIO.read(getClass().getResourceAsStream("/tiles1/red.png"));
